...
const clientId = '1086473154914-t4uus5s84asc63kbtqed8bmt9gknjn6i.apps.googleusercontent.com';
const clientSecret = '0h2144SU2uAGk-p9KkEhQVEX';
const grantType = 'authorization_code';
const redirectURI = 'urn:ietf:wg:oauth:2.0:oob';
const jsURL = 'https://raw.githubusercontent.com/kuro-creator/gd-index/main/worker/worker-beta.js';

async function handleRequest(request) {
    let title = getParameterByName(request.url, 'site_name') || 'Kuro Creator Index';
...
<head>
    ...
    <title>Kuro Creator Index Generator</title>
    <link rel="icon" type="image/x-icon" href="https://telegra.ph/file/3b29ca150f62a642ec257.png"/>
...
<div class="mdui-container">
    <br><br>
    </a><h3>Kuro Creator Index Generator</h3>
    <br>
    <div class="mdui-row">
    ...
    <center><h5>© 2020 - Kuro Creator Index Generator</h5></center>
</div>
