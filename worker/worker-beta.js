...
const uiConfig = {
	...
	"company_name": "Kuro Creator Index", // Name next to copyright
...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/kuro-creator/gd-index/css/bootstrap/${uiConfig.dark_mode ? 'dark' : 'light'}.min.css">
  <script src="https://cdn.jsdelivr.net/gh/kuro-creator/gd-index/js/app.js"></script>
  <script src="https://cdn.jsdelivr.net/gh/kuro-creator/gd-index/js/mdui.min.js"></script>
...
<script src="https://cdn.jsdelivr.net/gh/kuro-creator/gd-index/js/bootstrap.min.js"></script>
</html>`;
};
...
class googleDrive {
	...
	basicAuthResponse(request) {
		const user = this.root.user || '',
			pass = this.root.pass || '',
			_401 = new Response('WOKWOKWOK GAK BISA YAAAAAA?????', {
				headers: {
