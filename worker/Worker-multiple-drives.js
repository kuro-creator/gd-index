...
const authConfig = {
    "siteName": "Gawr Mirror Index", // Website name
    ...
    "roots":[
      ...
      },
      {
          ...
          "name": "Drive Two",
          "protect_file_link": false,
          "auth": {"yaro":"123456", "username1":"password1"} /* Remove double slash before "auth" to activate id password protection */
      },
    ]};
...
const uiConfig = {
    "theme": "slate", // switch between themes, default set to slate, select from https://github.com/kuro-creator/gd-index
    "version": "2.1.8", // don't touch this one.
    // If you're using Image then set to true, If you want text then set it to false
    "logo_image": false, // true if you're using image link in next option.
    "logo_height": "100x", // only if logo_image is true
    "logo_width": "100px", // only if logo_image is true
    "favicon": "https://icons.iconarchive.com/icons/google/noto-emoji-animals-nature/1024/22296-shark-icon.png",
    // if logo is true then link otherwise just text for name
    "logo_link_name": "Gawr Mirror Index",
    ...
    "nav_link_4": "Contact Person", // change navigation link name
    ...
    "company_name": "Gawr", // Name next to copyright
    "company_link": "https://gawr.floral.workers.dev", // link of copyright name
    ...
    "project1_name": ">Gawr Project",
    "project1_link": "https://gawr.floral.workers.dev",
